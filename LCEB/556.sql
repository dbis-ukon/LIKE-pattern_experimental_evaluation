...
WHERE t.title LIKE '_e%y_Bru%n _L%ny_B%c_'''
  AND akat.title LIKE 'Tragedy in a Coal Mine'
  AND k.keyword LIKE '%ne%-_he%er'
  AND n.name LIKE '%e_c_des'
  AND cn.name LIKE '%eg_H_nt'
  AND t.production_year BETWEEN 1910 AND 2011
